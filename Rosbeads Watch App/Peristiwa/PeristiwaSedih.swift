...
struct PeristiwaSedih: View {
    ...
    let audioFilesSedih = [
        ...
        "Peristiwa1Sedih.m4a", "Audio1.mp3", "Audio1.mp3", "Audio1.mp3", "Audio1.mp3", "Audio1.mp3", "Audio1.mp3", "Audio1.mp3", "Audio1.mp3","Audio1.mp3", "Audio1.mp3",
        "Peristiwa2Sedih.m4a", "Audio1.mp3", "Audio1.mp3", "Audio1.mp3", "Audio1.mp3", "Audio1.mp3", "Audio1.mp3", "Audio1.mp3", "Audio1.mp3","Audio1.mp3", "Audio1.mp3",
        "Peristiwa3Sedih.m4a", "Audio1.mp3", "Audio1.mp3", "Audio1.mp3", "Audio1.mp3", "Audio1.mp3", "Audio1.mp3", "Audio1.mp3", "Audio1.mp3","Audio1.mp3", "Audio1.mp3",
        "Peristiwa4Sedih.m4a", "Audio1.mp3", "Audio1.mp3", "Audio1.mp3", "Audio1.mp3", "Audio1.mp3", "Audio1.mp3", "Audio1.mp3", "Audio1.mp3","Audio1.mp3", "Audio1.mp3",
        "Peristiwa5Sedih.m4a", "Audio1.mp3", "Audio1.mp3", "Audio1.mp3", "Audio1.mp3", "Audio1.mp3", "Audio1.mp3", "Audio1.mp3", "Audio1.mp3","Audio1.mp3", "Audio1.mp3", "Salam ya Ratu.m4a"
    ...
    var body: some View {
        ZStack {
            ...
            BeadCircle(progress: progress, beadCount: 59, spacing: 0.7, beadSize: 5, largeBeadSize: 10, specialIndices: [0, 4, 15, 26, 37, 48], color: .purple)
                .frame(width: 175, height: 175)
...
//                    .foregroundColor(.green)
                ...
                Image(imageName)
                    ...
                    .onTapGesture {
                        if !progressStarted {
                            ...
                            if currentBeadIndex < audioFilesSedih.count - 1 {
                                currentBeadIndex += 1
                            } else {
    ...
    func playAudio(for index: Int) {
        WKInterfaceDevice.current().play(WKHapticType.start)
        guard index >= 0 && index < audioFilesSedih.count else {
            print("Invalid audio index")
            return
        }
        
        let audioFileName = audioFilesSedih[index]
